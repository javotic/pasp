...
@Component({
  selector: 'app-ejecucion-edd-desempeno',
  templateUrl: './ejecucion-edd-desempeno.component.html',
  styleUrls: ['./ejecucion-edd-desempeno.component.css']
})
export class EjecucionEddDesempenoComponent implements OnInit {
