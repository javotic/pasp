...
@Component({
  selector: 'app-recibos-nomina-sp',
  templateUrl: './recibos-nomina-sp.component.html',
  styleUrls: ['./recibos-nomina-sp.component.css'],
  providers: [DatePipe]
})
export class RecibosNominaSPComponent implements OnInit {
