...
export class DatosBancariosComponent implements OnInit {
  ...
  obtenerDatosBancarios(claveServidor: string) {
    this.pagosService.consultarDatosBancarios(claveServidor).subscribe(result => {
      this.datosBancarios = result.response;
    });
  }
