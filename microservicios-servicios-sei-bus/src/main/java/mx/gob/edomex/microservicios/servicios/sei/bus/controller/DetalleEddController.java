...
@RestController
@RequestMapping("/detalleedd")
public class DetalleEddController {
	@Autowired
	private DetalleEDDService detalleEDDService;
	...
	public BusResponse<List<DetalleEDD>> consultarServidoreseddua(
		...
		return new BusResponse<>("Succes", String.valueOf(HttpStatus.OK).replace("OK", ""), "OK",
				detalleEDDService.consultarDetalleEdd(idServidorPublico, idProceso));
	}
}
