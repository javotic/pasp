...
@RestController
@RequestMapping("/historialedd")
public class HistorialEvaluacionController {
	@Autowired
	private HistorialEvalService historialEvalService;
	...
	public BusResponse<List<HistorialEvaluaciones>> consultarEjecucuion(
		...
		return new BusResponse<>("Succes", String.valueOf(HttpStatus.OK), "OK",
				historialEvalService.consultarHistorialEvaluacion(idServidorPublico));
	}
