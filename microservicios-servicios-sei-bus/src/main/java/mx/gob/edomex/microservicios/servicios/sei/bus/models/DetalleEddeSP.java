...
public class DetalleEddeSP implements Serializable {
	...
	private List<ServidorPublicoEddUa> LSTSERVIDORESPUBLICOS;
	...
	@JsonProperty("LSTSERVIDORESPUBLICOS")
	public List<ServidorPublicoEddUa> getLSTSERVIDORESPUBLICOS() {
		return LSTSERVIDORESPUBLICOS;
	}

	public void setLSTSERVIDORESPUBLICOS(List<ServidorPublicoEddUa> lSTSERVIDORESPUBLICOS) {
		LSTSERVIDORESPUBLICOS = lSTSERVIDORESPUBLICOS;
	}
}
