...
@RestController
@RequestMapping("/procesovigente")
public class ProcesoVigenteController {

	@Autowired
	private ProcesoVigenteService procesoVigenteService;
	...
	public BusResponse<List<ProcesoVigente>> consultarServidoreseddua(
		...
		return new BusResponse<>("Succes", String.valueOf(HttpStatus.OK).replace("OK", ""), "OK",
				procesoVigenteService.consultarProcesoVigente(idServidorPublico));
	}
}
