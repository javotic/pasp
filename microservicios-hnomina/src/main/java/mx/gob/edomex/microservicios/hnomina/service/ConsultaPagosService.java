...
import mx.gob.edomex.microservicios.hnomina.dto.ListStringDTO;
 ...
 * @author smartinez
 */
public interface ConsultaPagosService {
    
    byte[] generarPagoQuincenal(ServidorComprobanteListDTO spComprobante) throws BusException; 
